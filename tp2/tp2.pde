...
void setup() {
  ...
  tamXboton2=120;
  tamYboton2=50;
  posXboton2=width/2-tamXboton2/2;
  posYboton2=height-80;
...
if (mouseX>posXboton2 && mouseX<posXboton2+tamXboton2 && mouseY>posYboton2 && mouseY<posYboton2+tamYboton2)

  fill(200, 0, 0);
  rect(posXboton2, posYboton2, tamXboton2, tamYboton2);

  fill(255);
  textAlign(CENTER, CENTER);
  textSize(20);
  text("REPLAY", posXboton2 + tamXboton2/2, posYboton2 + tamYboton2/2);
...
void mousePressed() {
  ...
  if (estado==8 && mouseX>posXboton2 && mouseX<posXboton2+tamXboton2 && mouseY>posYboton2 && mouseY<posYboton2+tamYboton2) {
